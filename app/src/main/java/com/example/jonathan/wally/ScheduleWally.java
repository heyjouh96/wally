...
public class ScheduleWally extends AppCompatActivity {

    WallyHorario horario;
    ScheduleWallyResponse wally;
    ...
    private void getWallyScheduleResponse(int id) throws IOException {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                ...
                ScheduleWally.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        try {
                            ...
                            wally = new ScheduleWallyResponse(json.getJSONObject("professor").getString("nm_pessoa")
                                    , horariosArr);
